...
const styles: Record<string, React.CSSProperties> = {
  ...
  counter: { fontSize: '0.85rem', color: '#64748b', marginBottom: '1rem', fontWeight: 600 },
  grid: {
    display: 'grid',
  ...
  num: { fontSize: '0.7rem', color: '#94a3b8', fontWeight: 700 },
  ...
  locked: { fontSize: '0.7rem', color: '#94a3b8' },
  level: { fontSize: '0.72rem', color: '#3b82f6', fontWeight: 700 },
};

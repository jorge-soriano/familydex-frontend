...
const styles: Record<string, React.CSSProperties> = {
  ...
  reqRow:        { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem', background: c.surface, borderRadius: 8, marginBottom: '0.5rem', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' },
  ...
  rewardCard:    { background: c.surface, borderRadius: 10, padding: '1.25rem', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
